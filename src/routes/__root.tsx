...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Guincho Brasil 24h | Reboque e Auto Socorro em Todo o Brasil" },
      ...
      { property: "og:title", content: "Guincho Brasil 24h | Reboque 24 Horas em Todo o Brasil" },
      { property: "og:description", content: "Portal nacional de guincho e reboque 24h. Atendimento rápido na sua cidade." },
